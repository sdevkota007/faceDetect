...
parser.add_argument(
    ...
    '--gtfolder',
    dest='gtFolder',
    default=os.path.join(currentPath, 'groundtruths-faces'),
    metavar='',
...
parser.add_argument(
    ...
    '--detfolder',
    dest='detFolder',
    default=os.path.join(currentPath, 'detections-faces'),
    metavar='',
...
if ValidateMandatoryArgs(args.gtFolder, '-gt/--gtfolder', errors):
    ...
    # errors.pop()
    gtFolder = os.path.join(currentPath, 'groundtruths-faces')
...
if ValidateMandatoryArgs(args.detFolder, '-det/--detfolder', errors):
    ...
    # errors.pop()
    detFolder = os.path.join(currentPath, 'detections-faces')
...
if args.savePath is not None:
    ...
    savePath = os.path.join(currentPath, 'results-faces')
# Validate savePath
